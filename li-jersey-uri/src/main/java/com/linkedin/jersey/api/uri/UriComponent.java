...
public class UriComponent {
     ...
     *         characters.
     */
    public static void validate(String s, Type t) throws IllegalArgumentException {
        validate(s, t, false);
    }
     ...
     *         detected
     */
    public static String decode(String s, Type t) throws IllegalArgumentException {
        if (s == null) {
    ...
    private static void decodeQueryParam(MultivaluedMap params,
    ...
    public static final class PathSegment
    {
        ...
        PathSegment(String path, boolean decode, MultivaluedMap matrixParameters) {
  ...
  /**
   * Add the path segment to the list of segments
   * @param segments the list of segments that should be added to
   * @param segment the path segment to add
   * @param decode true if the path segment to be added should be in decoded form
   */
    ...
    private static void decodeMatrixParam(MultivaluedMap params,
            String param, boolean decode) {
        int equals = param.indexOf('=');
        if (equals > 0) {
            params.add(
